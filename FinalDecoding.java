...
public class FinalDecoding {
    public static void main(String[] args) {
        ...
        //  * Finally, a Caesar cipher is used with key 5. ///////caesar key 5
        ...
        // decrypt caesar 5
        // even odd decrypt
        // backwards the words given

        /**
         * Originally as seen in my plan above I did it backwards due to logic errors in super cipher, but then fixed it
         * in order to allow the backward decryption of the cipherchain ciphers listed.
         * aka- I reversed the order of ciphers in order to match superciphers desired formatting.
         */
        BaseCipher[] cipherChain = {
                ...
                new WordReplacementCipher("fort knox", "my garage"),
                //idk why "fort knox" to "my garage" twice but the instructions said to on lines 16 and 18
